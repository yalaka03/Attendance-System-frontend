...
var URL_Page = "/employees/Numpages"
const EmployeeList = () => {
    ...
    useEffect(() => {
        ...
        const getpages = async () => {
            try {
                const response = await axiosPrivate.post(URL_Page, {
            ...
            <div style={{display: "flex", gap: "1.5rem", alignItems: "center", marginBottom: "1.5rem", padding: "0.75rem", background: "#f8fafc", borderRadius: "12px", border: "1px solid #e2e8f0"}}>
                ...
                <label style={{display: "flex", alignItems: "center", gap: "0.5rem", cursor: "pointer", userSelect: "none"}}>
                    <Checkbox
                        ...
                        inputProps={{ 'aria-label': 'Filter active employees' }}
                        sx={{
                            color: '#4f46e5',
                            '&.Mui-checked': {
                                color: '#4f46e5',
                ...
                <label style={{display: "flex", alignItems: "center", gap: "0.5rem", cursor: "pointer", userSelect: "none"}}>
                    <Checkbox
                        ...
                        inputProps={{ 'aria-label': 'Filter inactive employees' }}
                        sx={{
                            color: '#4f46e5',
                            '&.Mui-checked': {
                                color: '#4f46e5',
